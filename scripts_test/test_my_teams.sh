...
# Simple authentication with LOGIN + LOGOUT
test00()
{
  ...
  launch_test "$test_name" "$cmd1" 301
  launch_test "$test_name" "$cmd2" 102
  launch_test "$test_name" "$cmd3" 303
  launch_test "$test_name" "$cmd4" 503
  launch_test "$test_name" "$cmd5" 302
  launch_test "$test_name" "$cmd6" 303
  launch_test "$test_name" "$cmd7" 304
